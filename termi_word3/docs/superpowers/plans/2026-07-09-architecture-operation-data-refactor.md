...
from termi_word3.domain.results import ImportResult, SpellingResult
...
```python
from termi_word3.ui.keyboard import HIGH_IMPACT_ACTIONS, PendingConfirmation
...
```python
from termi_word3.screens.words import score_word_search
