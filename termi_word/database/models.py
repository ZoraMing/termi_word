...
class Setting(Base):
    ...
    home_key_study = Column(String(30), default="1")
    home_key_review = Column(String(30), default="2")
    home_key_spelling = Column(String(30), default="3")
    home_key_words = Column(String(30), default="4")
    home_key_calendar = Column(String(30), default="5")
    home_key_settings = Column(String(30), default="6")
